...
public class ScheduleManager {
	void updateaddSchedule(String roomid, String day, String start, String end) throws ClassNotFoundException, SQLException {
	...
	void updatedeleteSchedule(String roomid, String day, String start, String end) throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.jdbc.Driver");
		Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/testdb", "user", "1234");
		Statement state = conn.createStatement();
